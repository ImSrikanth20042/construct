...
import { LAMTable, LTAttendance, LDRTable } from "../../Tables";
...
const LAttendance = () => {
  ...
  return (
    <div className="max-container max-sm:mt-3 bg-gray-50 dark:bg-gray-900 h-full sm:h-fit p-10">
      ...
      <ALAMCards cards={eamCards} />
      <div className="grid grid-cols-2">
        <LAMRCard recentActivities={eamrActivities} />
      ...
      <LTAttendance labor={todayAttendance} />
      <div className=" flex justify-between items-center px-2 py-0 rounded-lg shadow-sm bg-white m-0.5 dark:bg-gray-900">
        {/* Title */}
      ...
      <LARCards report={aReport} />
      <LDRTable report={detailedReport} />
    </div>
  );
};
