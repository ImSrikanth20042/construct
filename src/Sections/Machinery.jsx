import { MachineryCards } from "../Cards";
import { machineryCards, machinerydata } from "../constants";
import MachineryTable from "../Tables/MachineryTable";
const Machinery = () => {
  return (
    <div className="flex-nowrap bg-white justify-between  dark:bg-gray-900 w-full h-screen p-10">
      ...
      <hr />
      <MachineryCards cards={machineryCards} />
      ...
      <MachineryTable data={machinerydata} />
