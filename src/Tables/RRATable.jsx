          ...
          <tbody>
            {data.map((report, index) => (
              <tr
                ...
                <td className="px-6 py-4">{report.gen}</td>
                <td className="px-6 py-4">{report.date}</td>
                <td className={`px-6 py-4 text-${report.statusTextColor}`}>
                  <span className={`${report.statusBg} rounded-3xl p-0.5`}>
                    {report.status}
                  </span>
                </td>
