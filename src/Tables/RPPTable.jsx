            ...
            {data.map((pay, index) => (
              <tr
                ...
                <th
                  ...
                  {pay.name} <br />
                  <span className="font-light">ID: {pay.id}</span>
                </th>
                <td className="px-6 py-4">{pay.type}</td>
                <td className="px-6 py-4">{pay.project}</td>
                <td className="px-6 py-4">{pay.hours}hrs</td>
                <td className="px-6 py-4">{pay.rate}/hr</td>
                <td className="px-6 py-4">{pay.ot}</td>
                <td className="px-6 py-4">{pay.ded}</td>
                <td className="px-6 py-4">{pay.np}</td>
                <td className={`px-6 py-4 text-${pay.statusTextColor}`}>
                  <span className={`${pay.statusBg} rounded-3xl p-0.5`}>
                    {pay.status}
                  </span>
                </td>
                ...
                <td className="px-6 py-4">
                  ...
                  <a
                    href="#"
                    className="font-medium mr-2 text-green-600 dark:text-green-300 hover:underline">
                    Pay Slip
                  </a>
                </td>
              </tr>
