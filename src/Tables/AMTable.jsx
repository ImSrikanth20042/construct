              ...
              <tr
                ...
                <th
                  ...
                  <div className="flex-wrap ml-5">
                    {e.name}
                    <br /> <span className="font-light">ID: {e.id}</span>
                  </div>
                </th>
                <td className="px-6 py-4">{e.date}</td>
                <td className="px-6 py-4">{e.in}</td>
                <td className="px-6 py-4">{e.out}</td>
                <td className="px-6 py-4">{e.hrs}</td>
                <td className="px-6 py-4 m-2 ">
                  <span
                    className={`${e.statusBg} rounded-xl p-1.5 dark:text-gray-900`}>
                    {e.status}
                  </span>
                </td>
